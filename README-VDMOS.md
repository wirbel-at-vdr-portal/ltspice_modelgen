...
IMPORTANT: if you can get a spice model from the MOSFET vendor, it will be more precise as such autogenerated model line. You should always prefer vendor models.
